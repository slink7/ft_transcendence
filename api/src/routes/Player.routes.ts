...
playerRouter.get("/username/:username", jwtAuth, async (req, res) => { getPlayer(req, res, "username"); });
playerRouter.get("/id_player/:id_player", jwtAuth, async (req, res) => { getPlayer(req, res, "id_player"); });
